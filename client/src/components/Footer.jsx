  ...
  return (
    <div className="w-full bg-gray-900 text-gray-300 py-8 px-2">
      ...
      <div className="flex flex-col max-w-[1240px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500">
        <p className="py-4">2025 Benevolent World Travel, LLC. All rights reserved</p>
        <div className="flex justify-between sm:w-[300px] pt-4 text-2xl">
          <FaFacebook  href='https://www.facebook.com/'/>
          <FaInstagram href='https://www.instagrm.com/' />
          <FaTwitter href='https://www.twitter.com/' />
          <FaPinterest href='https://www.pinterest.com/' />
          <FaYoutube href='https://www.youtube.com/'/>
        </div>
      </div>
    </div>
  );
